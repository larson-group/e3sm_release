...
#  call('rm -f  ',filepath[im]+cases[im]+'/'+cases[im]+'_*_climo.nc')
   ...
   #  ncea_str='/global/common/sw/cray/cnl7/haswell/nco/4.7.9/gcc/8.2.0/unbt25h/bin/ncea '
     ...
     outfile=datalocal+'climo_2/'+cases[im]+'_ANN_climo.nc'
     infile=datalocal+'climo_2/'+cases[im]+'_SON_climo.nc '+datalocal+'climo_2/'+cases[im]+'_JJA_climo.nc '+datalocal+'climo_2/'+cases[im]+'_MAM_climo.nc '+datalocal+'climo_2/'+cases[im]+'_DJF_climo.nc '
     os.system(ncea_str+infile +' -O '+outfile)
   
     ln_str='ln -s '
     os.system(ln_str+ datalocal+'climo_2/'+cases[im]+'_SON_climo.nc' +' '+ datalocal+'climo_2/'+cases[im]+'_SON_budget_climo.nc' )
     os.system(ln_str+ datalocal+'climo_2/'+cases[im]+'_MAM_climo.nc' +' '+ datalocal+'climo_2/'+cases[im]+'_MAM_budget_climo.nc' )
     os.system(ln_str+ datalocal+'climo_2/'+cases[im]+'_JJA_climo.nc' +' '+ datalocal+'climo_2/'+cases[im]+'_JJA_budget_climo.nc' )
