...
set job_name       = zm_clb_tau_clean_F2010SC5-CMIP6 
...
$xmlchange_exe --id CAM_CONFIG_OPTS --append --val=" -cppdefs '-DUWM_MISC'"
...
cat <<EOF >> user_nl_cam 
 ...
 'U','PS','T','V','OMEGA','Z3','PRECT', 'CLDLIQ', 'CLDICE', 'LWCF', 'SWCF', 'FLUT',
 'TMQ', 'PRECC', 'PRECL', 'CME', 'PRODPREC', 'EVAPPREC','EVAPSNOW','ICWMRST','ICIMRST','PRAO',
 'PRCO','QCSEVAP','QISEVAP','QVRES','CMEIOUT','VTRMI', 'VTRMC','QCSEDTEN','QISEDTEN','MNUCCCO','MNUCCTO',
 'MNUCCDO','MNUCCDOhet','MSACWIO','PSACWSO','BERGSO', 'BERGO','MELTO','HOMOO','QCRESO','PRCIO','PRAIO',
 'MELTSDT','FRZRDT','ADRAIN','ADSNOW','FREQR','FREQS', 'PE','APRL','PEFRAC','VPRCO','VPRAO','RACAU',
...
! How to turn on SILHS? deep_scheme='off', subcol_scheme = 'SILHS',use_subcol_microp = .true.,microp_uniform = .true. 
 deep_scheme = 'ZM'         ! off
 subcol_scheme = 'off'     ! SILHS
 use_subcol_microp = .false.  ! true
 microp_uniform = .false.     ! true
