...
param.test_data_path = '/lcrc/group/acme/ac.griffin/E3SM_simulations/anvil.default.clubb_silhs_test.ne16_ne16/run/climo/'
param.test_name = 'anvil.default.clubb_silhs_test.ne16_ne16'
...
param.results_dir = os.path.join(prefix, 'clubb_silhs_test')
