...
param.test_data_path = '/lcrc/group/acme/ac.griffin/E3SM_simulations/anvil.default.clubb_silhs_upgrade_c689c7e_test.ne30_ne30/run/climo/'
param.test_name = 'anvil.default.clubb_silhs_upgrade_c689c7e_test.ne30_ne30'
...
param.results_dir = os.path.join(prefix, 'clubb_silhs_upgrade_c689c7e_test')
