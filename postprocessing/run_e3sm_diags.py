...
param.test_data_path = '/lcrc/group/acme/ac.griffin/E3SM_simulations/anvil.default.clubb_silhs_E3SM_master_merge.ne30_ne30/run/climo/'
param.test_name = 'anvil.default.clubb_silhs_E3SM_master_merge.ne30_ne30'
...
param.results_dir = os.path.join(prefix, 'clubb_silhs_E3SM_master_merge')
