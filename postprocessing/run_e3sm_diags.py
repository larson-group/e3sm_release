...
param.test_data_path = '/lcrc/group/acme/ac.griffin/E3SM_simulations/anvil.default.NGD_clubb_silhs_P3_1deg.ne30pg2_r05_oECv3/run/climo/'
param.test_name = 'anvil.default.NGD_clubb_silhs_P3_1deg.ne30pg2_r05_oECv3'
...
param.results_dir = os.path.join(prefix, 'NGD_clubb_silhs_P3_1deg')
